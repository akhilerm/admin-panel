...
//      $row=$result->fetch_assoc();
		$sql_update1="delete from  transactions where trans_id='".$otid."'";
        $result1=$con->query($sql_update1) or die(mysqli_error());
        
        
        $sql_update2="update  event_participants set trans_id=''  where trans_id='".$otid."'";
        $result2=$con->query($sql_update2) or die(mysqli_error());
        
        $sql_update3="update  event_participants_spot set trans_id='' where trans_id='".$otid."'";
