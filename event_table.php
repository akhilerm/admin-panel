...
<?php
			  ...
			  {    
				...
				$event_list="select * from event_participants as ep,events as e,transactions as t where ep.trans_id=t.trans_id and e.event_id=ep.event_id and eps.part_id='".$row['id']."'";
			  $result=$con->query($event_list);
			  if($result)
			  {    
			  	if($result->num_rows>0)
			  	{
			        ...
			        echo "<td style= 'color: black;'>".$row_event["amt"]."</td><td style= 'color: black;'>".$row_event["trans_id"]."</td>";	
					    ...
					    if(1)
					    {
					    	echo "<td style= 'color: black;'>Amount Payed</td>";     	
					    }
					    else
